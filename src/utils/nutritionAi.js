...
const FOOD_DATABASE = {
  ...
  'chicken curry': { aliases: ['kerala chicken curry', 'kozhi curry', 'nadan chicken curry'], name: 'Kerala Chicken Curry', serving: '100g', cal: 175, p: 18.0, c: 3.0, f: 10.0, tip: 'Focus on chicken pieces; moderate the oily gravy.' },
  'fish curry': { aliases: ['meen curry', 'kerala fish curry', 'ayala curry', 'mathi curry', 'kudampuli fish curry'], name: 'Kerala Fish Curry', serving: '100g fish + gravy', cal: 135, p: 19.5, c: 1.5, f: 5.5, tip: 'Low calorie, rich in Omega-3 fatty acids.' },
  'grilled fish': { aliases: ['tawa fish', 'fish tawa fry', 'pollichathu', 'meen pollichathu'], name: 'Grilled / Tawa Fish', serving: '100g', cal: 140, p: 22.0, c: 0.5, f: 5.5, tip: 'Lean, clean, high-satiety protein source.' },
  'fish fry': { aliases: ['fried fish', 'meen varuthathu', 'meen fry'], name: 'Fish Fry', serving: '1 piece (80g)', cal: 160, p: 16.0, c: 2.5, f: 9.5, tip: 'Absorbs cooking oil. Prefer shallow tawa fry or curry.' },
